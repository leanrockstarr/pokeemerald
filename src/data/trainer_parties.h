...
static const struct TrainerMonItemCustomMoves sParty_GruntPetalburgWoods[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_BODY_SLAM, MOVE_SHADOW_BALL, MOVE_COUNTER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy1[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BELLY_DRUM, MOVE_BODY_SLAM, MOVE_SHADOW_BALL, MOVE_SUBSTITUTE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winston1[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_FOCUS_PUNCH, MOVE_SHADOW_BALL, MOVE_YAWN}
    }
};
...
static const struct TrainerMonItemCustomMovesEVs sParty_Brawly1[] = {
    {
    .iv = 255,
    .lvl = 100,
    .evs = {252, 252, 0, 0, 4, 0},
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNums = 0,
    .moves = {MOVE_SPORE, MOVE_SKY_UPPERCUT, MOVE_MACH_PUNCH, MOVE_LEECH_SEED}
    },
    {
    .iv = 255,
    .lvl = 100,
    .evs = {128, 252, 0, 0, 4, 124},
    .species = SPECIES_HITMONTOP,
    .heldItem = ITEM_LEFTOVERS,
    .abilityNums = 0,
    .moves = {MOVE_MACH_PUNCH, MOVE_HI_JUMP_KICK, MOVE_ROCK_SLIDE, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .abilityNums = 0,
    .moves = {MOVE_HI_JUMP_KICK, MOVE_ROCK_SLIDE, MOVE_MACH_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNums = 0,
    .moves = {MOVE_BULK_UP, MOVE_BRICK_BREAK, MOVE_SHADOW_BALL, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNums = 1,
    .moves = {MOVE_CROSS_CHOP, MOVE_ROCK_TOMB, MOVE_KNOCK_OFF, MOVE_COUNTER}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_SALAC_BERRY,
    .abilityNums = 0,
    .moves = {MOVE_FIRE_BLAST, MOVE_THUNDER_PUNCH, MOVE_SKY_UPPERCUT, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jerry1[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CALM_MIND, MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_ICE_PUNCH}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Billy[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BELLY_DRUM, MOVE_BODY_SLAM, MOVE_SHADOW_BALL, MOVE_SUNNY_DAY}
    },
	{
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_QUICK_ATTACK, MOVE_SHADOW_BALL, MOVE_BRICK_BREAK}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Josh[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_EXPLOSION, MOVE_REST}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Allen[] = {
    ...
    .moves = {MOVE_AERIAL_ACE, MOVE_FACADE, MOVE_QUICK_ATTACK, MOVE_DOUBLE_TEAM}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Ivan[] = {
    ...
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_THUNDER_WAVE, MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_ICY_WIND}
    },
	{
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Elliot1[] = {
    ...
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_HYDRO_PUMP}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .species = SPECIES_AZUMARILL,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_IRON_TAIL, MOVE_HYDRO_PUMP, MOVE_BRICK_BREAK}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Laura[] = {
    ...
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_BULK_UP, MOVE_SHADOW_BALL, MOVE_BRICK_BREAK, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Marc[] = {
    ...
    .species = SPECIES_RHYDON,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_MEGAHORN, MOVE_SWORDS_DANCE}
    },
	{
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Brenden[] = {
    ...
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CROSS_CHOP, MOVE_ROCK_SLIDE, MOVE_FACADE, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Lilith[] = {
    ...
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FAKE_OUT, MOVE_SHADOW_BALL, MOVE_BRICK_BREAK, MOVE_RECOVER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cristian[] = {
    ...
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BULK_UP, MOVE_CROSS_CHOP, MOVE_ROCK_SLIDE, MOVE_FAKE_OUT}
    }
};
...
static const struct TrainerMonItemCustomMovesEVs sParty_BrendanRustboroTreecko[] = {
    {
    .iv = 255,
    .lvl = 100,
    .evs = {0, 252, 0, 0, 4, 252},
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNums = 0,
    .moves = {MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_BRICK_BREAK, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_SALAC_BERRY,
    .abilityNums = 0,
    .moves = {MOVE_REVERSAL, MOVE_FIRE_BLAST, MOVE_QUICK_ATTACK, MOVE_SWORDS_DANCE}
    }
};

static const struct TrainerMonItemCustomMovesEVs sParty_BrendanRustboroMudkip[] = {
    {
    .iv = 255,
    .lvl = 100,
    .evs = {252, 252, 0, 0, 0, 4},
    ...
    .heldItem = ITEM_LEFTOVERS,
    .abilityNums = 1,
    .moves = {MOVE_SUBSTITUTE, MOVE_FOCUS_PUNCH, MOVE_DOUBLE_EDGE, MOVE_SING}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_PETAYA_BERRY,
    .abilityNums = 0,
    .moves = {MOVE_SUBSTITUTE, MOVE_LEECH_SEED, MOVE_LEAF_BLADE, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMovesEVs sParty_BrendanRustboroTorchic[] = {
    {
    .iv = 255,
    .lvl = 100,
    .evs = {100, 0, 0, 252, 0, 156},
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_LEFTOVERS,
    .abilityNums = 0,
    .moves = {MOVE_HEAT_WAVE, MOVE_HYPNOSIS, MOVE_WILL_O_WISP , MOVE_FAINT_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .abilityNums = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_ICE_BEAM, MOVE_REST}
    }
};

static const struct TrainerMonItemCustomMovesEVs sParty_MayRustboroMudkip[] = {
    {
    .iv = 255,
    .lvl = 100,
    .evs = {252, 252, 0, 0, 0, 4},
...
static const struct TrainerMonItemCustomMoves sParty_Rick[] = {
    ...
    .species = SPECIES_DUSTOX,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_GIGA_DRAIN, MOVE_PSYCHIC, MOVE_TOXIC, MOVE_MOONLIGHT}
    },
	{
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_BEAUTIFLY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STUN_SPORE, MOVE_GIGA_DRAIN, MOVE_PSYCHIC, MOVE_MORNING_SUN}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Lyle[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SPIKES, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE, MOVE_EXPLOSION}
    },
	{
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_MASQUERAIN,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_HYDRO_PUMP, MOVE_GIGA_DRAIN, MOVE_STUN_SPORE, MOVE_ICY_WIND}
    },
    {
    .iv = 0,
    .lvl = 27,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SWORDS_DANCE, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jose[] = {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_DIG, MOVE_SILVER_WIND, MOVE_AERIAL_ACE}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Sarah[] = {
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_ICE_BEAM, MOVE_HYDRO_PUMP, MOVE_FAKE_OUT, MOVE_GIGA_DRAIN}
    },
	{
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMovesEVs sParty_MayRustboroTreecko[] = {
    {
    .iv = 255,
    .lvl = 100,
    .evs = {0, 252, 0, 0, 4, 252},
...
static const struct TrainerMonItemCustomMovesEVs sParty_MayRustboroTorchic[] = {
    {
    .iv = 255,
    .lvl = 100,
    .evs = {100, 0, 0, 252, 0, 156},
